...
import ru.pp.w5277c.yaji.components.JREComponent;
...
public class Config {
	...
	public			static	String						APP_SOURCE		= "data";
	...
	public Config() {
		APP_COMPONENTS.add(new JREComponent("jre", "JRE", "", "11", true));
		APP_COMPONENTS.add(new LaunchComponent(	"app", APP_NAME, "comment", "0.1",
												"app/launcher", "app/icon", "Other;", true, true, true, true, true));
